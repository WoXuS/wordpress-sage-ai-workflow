...
<a href="{{ $service['url'] }}"
   class="group/tile flex flex-col justify-between items-center fl-gap-8/20 rounded-2xl bg-red fl-px-4/10 fl-pb-7/10 pt-10 xs:fl-pt-15/38 text-white transition-shadow hover:shadow-lg">
